...
class MiniSom(object):
    ...
    def get_winner(self, x):
        self._activate(x)
        best = unravel_index(self._activation_map.argmin(),
                             self._activation_map.shape)
        self._activation_map[best[0]][best[1]] = self._activation_map.max()
        second = unravel_index(self._activation_map.argmin(),
                             self._activation_map.shape)
        return best, second
